...
# Load evo_model
evo_model = RNNModel.load(open(r"evapotranspiration_model.pt", encoding='utf-8'), map_location='cpu')
evo_model.to_cpu()

# Load pre_rate_model
pre_rate_model = RNNModel.load(open(r'precipitation_rate_model.pt', encoding='utf-8'), map_location='cpu')
